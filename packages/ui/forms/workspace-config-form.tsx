...
function reducer(
  state: GetWorkspaceConfig_workspace_config,
  {
    name,
    value,
  }: {
    ...
    value:
      ...
      | object
      | null
      | Partial<GetWorkspaceConfig_workspace_config>;
  },
): GetWorkspaceConfig_workspace_config {
  switch (name) {
    case "full":
...
export const WorkspaceConfigForm: React.FC<WorkspaceConfigFormProps> = () => {
  ...
  return (
    <>
      ...
      <div className="columns py-6 my-4">
        ...
        <div className="column is-4">
            ...
            addonRight={
              <>
                {payload.default_currency !==
                  workspace_config?.default_currency && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "default_currency",
                          value: workspace_config!.default_currency,
                        })
                      }
                    ...
                    <button
                      onClick={() =>
                        mutation.updateWorkspaceConfig.mutateAsync({
          ...
          <SelectField
            ...
            addonRight={
              <>
                {payload.default_country_code !==
                  workspace_config?.default_country_code && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "default_country",
                          value: workspace_config!.default_country_code,
                        })
                      }
                      className="button is-small is-default"
                    >
          ...
          <SelectField
            ...
            addonRight={
              <>
                {payload.default_label_type !==
                  workspace_config?.default_label_type && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "default_label_type",
                          value: workspace_config!.default_label_type,
                        })
                      }
                      className="button is-small is-default"
                    >
                    ...
                    <button
                      onClick={() =>
                        mutation.updateWorkspaceConfig.mutateAsync({
                          default_label_type: payload.default_label_type,
                        })
                      }
                      className={`button is-small is-success ${mutation.updateWorkspaceConfig.isLoading ? "is-loading" : ""}`}
                    >
          ...
          <SelectField
            ...
            onChange={(e) => {
              const value =
                e.target.value === "none" || isNoneOrEmpty(e.target.value)
                  ? null
                  : e.target.value;
              dispatch({
                name: "partial",
            ...
            addonRight={
              <>
                {payload.default_weight_unit !==
                  workspace_config?.default_weight_unit && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          ...
                          value: {
                            ...
                            default_dimension_unit:
                              workspace_config!.default_dimension_unit,
                          },
                        })
                      }
                      className="button is-small is-default"
                    ...
                    <button
                      onClick={() =>
                        mutation.updateWorkspaceConfig.mutateAsync({
                          ...
                          default_dimension_unit:
                            payload.default_dimension_unit,
                        })
                      }
                      className={`button is-small is-success ${mutation.updateWorkspaceConfig.isLoading ? "is-loading" : ""}`}
                    >
      ...
      <div className="columns py-6 my-4">
        ...
        <div className="column is-4">
                  ...
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "tax_id",
                          value: workspace_config!.state_tax_id,
                        })
                      }
                      className="button is-small is-default"
                    >
                    ...
                    <button
                      onClick={() =>
                        mutation.updateWorkspaceConfig.mutateAsync({
                          state_tax_id: payload.state_tax_id,
                        })
                      }
                      className={`button is-small is-success ${mutation.updateWorkspaceConfig.isLoading ? "is-loading" : ""}`}
                    >
          ...
          <InputField
            ...
            addonRight={
              <>
                {payload.federal_tax_id !==
                  workspace_config?.federal_tax_id && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "federal_tax_id",
                          value: workspace_config!.federal_tax_id,
                        })
                      }
                      className="button is-small is-default"
                    >
      ...
      <div className="columns py-6 my-4">
        <div className="column is-5 pr-2">
          <p className="subtitle is-6 py-1">Default Shipping Options</p>
          <p className="is-size-7 pr-2">
            Set up shipping options to automatically apply.
          </p>
        </div>
        ...
        <div className="column is-4">
          ...
          <CheckBoxField
            ...
            onChange={(e) => {
              dispatch({
                name: "insured_by_default",
                value: workspace_config!.insured_by_default,
              });
              mutation.updateWorkspaceConfig.mutateAsync({
                insured_by_default: e.target.checked,
              });
            }}
            defaultChecked={payload?.insured_by_default as any}
            disabled={!(user?.permissions || []).includes("manage_team")}
            fieldClass={`column mb-0 p-0`}
          >
            <span>Insure full package value by default</span>
          </CheckBoxField>
        </div>
      </div>
      ...
      <div className="columns py-6 my-4">
        ...
        <div className="column is-4">
                  ...
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "customs_aes",
                          value: workspace_config!.customs_aes,
                        })
                      }
                      className="button is-small is-default"
                    >
                    ...
                    <button
                      onClick={() =>
                        mutation.updateWorkspaceConfig.mutateAsync({
                          customs_aes: payload.customs_aes,
                        })
                      }
                      className={`button is-small is-success ${mutation.updateWorkspaceConfig.isLoading ? "is-loading" : ""}`}
                    >
          ...
          <InputField
            ...
            addonRight={
              <>
                {payload.customs_eel_pfc !==
                  workspace_config?.customs_eel_pfc && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "customs_eel_pfc",
                          value: workspace_config!.customs_eel_pfc,
                        })
                      }
                      className="button is-small is-default"
                    >
                    ...
                    <button
                      onClick={() =>
                        mutation.updateWorkspaceConfig.mutateAsync({
                          customs_eel_pfc: payload.customs_eel_pfc,
                        })
                      }
                      className={`button is-small is-success ${mutation.updateWorkspaceConfig.isLoading ? "is-loading" : ""}`}
                    >
          ...
          <InputField
            ...
            addonRight={
              <>
                {payload.customs_license_number !==
                  workspace_config?.customs_license_number && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "customs_license_number",
                          value: workspace_config!.customs_license_number,
                        })
                      }
                      className="button is-small is-default"
                    >
          ...
          <InputField
            ...
            addonRight={
              <>
                {payload.customs_certificate_number !==
                  workspace_config?.customs_certificate_number && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "customs_certificate_number",
                          value: workspace_config!.customs_certificate_number,
                        })
                      }
                      className="button is-small is-default"
                    >
          ...
          <InputField
            ...
            addonRight={
              <>
                {payload.customs_nip_number !==
                  workspace_config?.customs_nip_number && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "customs_nip_number",
                          value: workspace_config!.customs_nip_number,
                        })
                      }
                      className="button is-small is-default"
                    >
                    ...
                    <button
                      onClick={() =>
                        mutation.updateWorkspaceConfig.mutateAsync({
                          customs_nip_number: payload.customs_nip_number,
                        })
                      }
                      className={`button is-small is-success ${mutation.updateWorkspaceConfig.isLoading ? "is-loading" : ""}`}
                    >
          ...
          <InputField
            ...
            addonRight={
              <>
                {payload.customs_eori_number !==
                  workspace_config?.customs_eori_number && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
                          name: "customs_eori_number",
                          value: workspace_config!.customs_eori_number,
                        })
                      }
                      className="button is-small is-default"
                    >
                    ...
                    <button
                      onClick={() =>
                        mutation.updateWorkspaceConfig.mutateAsync({
                          customs_eori_number: payload.customs_eori_number,
                        })
                      }
                      className={`button is-small is-success ${mutation.updateWorkspaceConfig.isLoading ? "is-loading" : ""}`}
                    >
          ...
          <InputField
            ...
            addonRight={
              <>
                {payload.customs_vat_registration_number !==
                  workspace_config?.customs_vat_registration_number && (
                  <div className="buttons">
                    <button
                      onClick={() =>
                        dispatch({
